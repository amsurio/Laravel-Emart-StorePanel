...
<script>
    ...
    $(document).ready(function () {
        ...
        ref.get().then(async function (snapshots) {
            ...
            if(curr_status == "Order Completed"){
        ...
        allreviewdata.forEach((listval) => {
            ...
            vendorOrder.products.forEach((productval) => {
                if (productval.id == val.productId) {
                    ...
                    reviewhtml = reviewhtml + '<a href="javascript:void(0);"><img alt="#" src="' + photo + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'" class=" img-circle img-size-32 mr-2" style="width:60px;height:60px"></a>';
    ...
    function buildHTMLProductsList(snapshotsProducts) {
        ...
        snapshotsProducts.forEach((product) => {
            ...
            if (val.photo != '') {
                ...
                html = html + '<img class="img-circle img-size-32 mr-2" style="width:60px;height:60px;" src="' + photo + '" onerror="this.onerror=null;this.src=\'' + place_image + '\'" alt="image">';
            } else {
